...
|-------------|-------|----------|
| Multi-step task, "build a system", "implement X and Y", compound requests | **engineering-manager** | Plan steps, delegate to agents (parallel when independent, sequential when dependent) |
