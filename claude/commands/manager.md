---
description: Plan and delegate a multi-step task using the engineering manager agent
---
...
5. Always include test-agent for new functionality
6. Always end with review-agent for non-trivial changes
