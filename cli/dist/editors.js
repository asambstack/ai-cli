...
export function detectEditors(root) {
    const detected = [];
...
export async function linkEditor(root, editorId, contextPath) {
...
export async function unlinkEditor(root, editorId) {
    const editor = EDITORS.find((e) => e.id === editorId);
    if (!editor) {
        return { ok: false, message: `Unknown editor: ${editorId}` };
    }
...
export function getEditorDef(id) {
