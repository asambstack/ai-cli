...
async function listMdFiles(dir: string): Promise<readonly AgentSummary[]> {
  try {
...
async function getMdFile(dir: string, name: string): Promise<AgentFile | null> {
...
export const getAgent = (name: string) => getMdFile(AGENTS_DIR, name);
export const updateAgent = (name: string, content: string) =>
  updateMdFile(AGENTS_DIR, name, content);

// Skills
export const listSkills = () => listMdFiles(SKILLS_DIR);
export const getSkill = (name: string) => getMdFile(SKILLS_DIR, name);
export const updateSkill = (name: string, content: string) =>
  updateMdFile(SKILLS_DIR, name, content);

// Rules
export const listRules = () => listMdFiles(RULES_DIR);
export const getRule = (name: string) => getMdFile(RULES_DIR, name);
export const updateRule = (name: string, content: string) =>
  updateMdFile(RULES_DIR, name, content);
